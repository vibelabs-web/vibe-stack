            ...
            <div className={styles.container}>
                <div className={styles.leftSection}>
                    <Link to="/" className={styles.logo}>
                        ...
                        <h2 className={styles.logoText}>Vibelabs</h2>
                    </Link>
                ...
                <div className={styles.rightSection}>
                    <div className={styles.navLinks}>
                        <Link to="/" className={styles.navLink}>Explore</Link>
                        <Link to="/ranking" className={styles.navLink}>Community</Link>
                    </div>
                            ...
                            <>
                                ...
                                <Link to="/profile">
                                    {user.avatar_url ? (
                                        ...
                                        <div className={styles.profileAvatar} title={user.nickname}>
                                            <span className="material-symbols-outlined" style={{ fontSize: '1.25rem', color: '#999' }}>person</span>
                                        </div>
                                    )}
                                </Link>
                            </>
